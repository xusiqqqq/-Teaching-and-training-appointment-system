...
public class TReservationRecordMapperTest {
	...
	//删除多条记录
		...
		idList.add(7);
		idList.add(8);
		reserveMapper.deleteBatchIds(idList);
	...
	//根据条件值删除
		...
		int deleteCount = reserveMapper.deleteByMap(columnMap);
	...
	//查询一条记录
		...
		public void selectOne() {
			//根据id查询
			reserveMapper.selectById(3);
			toPrint("查询", 1, reserve);
		}
	//查询多条数据
		//根据id查询
		@Test
		public void selectManyById() {
			...
			idList.add(4);
			idList.add(5);
			List<TReservationRecord> ids = reserveMapper.selectBatchIds(idList);
		...
		public void selectManyByCase() {
			...
			List<TReservationRecord> list = reserveMapper.selectByMap(columnMap);
	...
	//=====使用Wrapper
		...
		public void selectCount() {
			Integer count = reserveMapper.selectCount(null);
			toPrint("查询", 1, count);
		}
		...
		List<Map<String, Object>> list = reserveMapper.selectMaps(null);
		toPrint("查询", list.size(), list);
		}
		//分页展示
		@Test
		public void selectAllOnMapPage() {
			...
			IPage<Map<String, Object>> pageList = reserveMapper.selectMapsPage(page, null);
		...
		//根据id查询出实体数据
		public TReservationRecord findById(Integer id) {
			reserve = reserveMapper.selectById(id);
			return reserve;
		}
